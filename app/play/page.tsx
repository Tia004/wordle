        ...
        <div style={{ position: 'relative', display: 'flex', flexDirection: 'column', alignItems: 'center', width: '100%', height: '100%' }}>
            ...
            <div style={{ width: '100%', display: 'flex', alignItems: 'center', marginBottom: 'var(--board-gap)', flexShrink: 0, gap: '0.4rem' }}>
                ...
                <div style={{ flex: 1, display: 'flex', alignItems: 'center' }}>
                    <div style={{ display: 'flex', alignItems: 'center', gap: '0.4rem', background: 'white', padding: '0.4rem 0.8rem', borderRadius: '20px', border: '3px solid var(--carrd-border)', fontWeight: 'bold', color: 'var(--carrd-border)' }}>
                ...
                <div style={{ flex: 1, display: 'flex', justifyContent: 'flex-end' }}>
                    <button
                        ...
                        style={{
                            ...
                            background: 'var(--secondary)', padding: '0.4rem 0.8rem',
